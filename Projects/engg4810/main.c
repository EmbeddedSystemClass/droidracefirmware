...
int main(void) {
    ...
    digiscope_cli_init();
    digiscope_signalgen_init();
    digiscope_net_init();

    digiscope_adc_init_ch1();
    digiscope_adc_init_ch2();

    /* Init triggering with 1MHz sampling rate and 8 bit mode */
    digiscope_adc_trigger_init();

    lowlevel_spi1_bus_init();
